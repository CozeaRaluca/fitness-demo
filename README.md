# Fitness Demo Project

It was built in [CodeSandbox](https://codesandbox.io) with [Astro](https://docs.astro.build).

---------------------------
# Predefined README | Welcome to [Astro](https://astro.build)
